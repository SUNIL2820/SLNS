  ...
  return (
    <div className="min-h-screen bg-white font-sans scroll-smooth">
      ...
      <section className="flex flex-col lg:flex-row min-h-screen pt-16">
        {/* Left Side - Cement Image with Cards Overlay */}
        <div className="w-full lg:w-1/2 relative flex items-center justify-center">
          {/* Cement image resized */}
          <img
          ...
          {/* Two Cards Overlay */}
          <div className="absolute bottom-[-3rem] left-0 right-0 z-20 px-6">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-gray-600 max-w-4xl">
              ...
              Every machine is maintained under strict SOPs to support 24/7 operations and the
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                key={i}
                className="relative text-white p-6 shadow-xl rounded-xl overflow-hidden min-h-[320px] flex flex-col justify-between hover:scale-[1.04] hover:shadow-2xl transition-all duration-500"
                variants={fadeUp}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true, amount: 0.3 }}
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  <h3
                    className="text-xl font-bold mb-4 uppercase text-[#F9B233]"
                    style={{ fontFamily: "'Bebas Neue', sans-serif" }}
                  >
                    {card.title}
                  </h3>
                  <ul className="space-y-3 text-sm leading-relaxed text-white flex-grow">
