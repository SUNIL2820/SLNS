...
const About = () => {
    return (
        <div className="w-full">
            ...
            <section className="relative w-full h-screen flex items-center justify-between -mt-20">
                {/* Left Image */}
                ...
                <div className="w-1/3 text-center">
                    <h2 className="text-3xl md:text-6xl text-[#FFB91E] mb-4" style={{ fontFamily: "'bebas Neue', sans-serif" }}>
                        About Us
                    </h2>
                </div>
            ...
            <section className="relative w-full py-16 -mt-14 flex items-center justify-center">
                <img
            ...
            <section className="relative w-full flex items-center justify-center py-0 px-6 md:px-0">
                <img
                ...
                <div className="absolute inset-0 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-20 text-white text-center md:text-left px-6 md:px-20">
                    <div className="md:w-1/3">
                        <h3 className="text-2xl md:text-3xl font-bold mb-2" style={{ fontFamily: "'Sora', sans-serif" }}>
                            Our Vision
                        </h3>
