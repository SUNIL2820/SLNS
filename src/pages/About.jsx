    ...
    return (
        <div className="w-full overflow-x-hidden">
            ...
            <section className="relative w-full py-6 md:py-12 flex items-center justify-center" data-aos="fade-up">
                ...
                <div className="relative z-10 text-center px-6 md:px-20 py-10 text-white">
                    <p className="text-base md:text-xl leading-relaxed"
                        style={{ fontFamily: "'Sora', sans-serif" }} data-aos="fade-up">
            ...
            <section className="w-full bg-white py-12 px-6 md:px-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-16" data-aos="fade-up">
                    ...
                    <div className="flex items-center space-x-6">
                        ...
                        />
                        <div>
                            <h6 className="text-sm md:text-lg text-[#213C58]">
                                2015
                            </h6>
                            <h3 className="text-lg md:text-2xl font-bold text-[#213C58]">

                                Quality Management System
                            </h3>
                            <p className="text-gray-600 text-xs md:text-sm">
                                Certificate No: Q-0110242795<br />
                                Ensures end-to-end quality control in<br></br>batching, testing, and delivery operations.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center space-x-6">
                        <img
                            src="/assets/qci.png"
                            alt="QCI Logo"
                            className="px-2 md:px-0 w-28 h-28 md:w-28 md:h-28 object-contain"
                        />
                        <div>
                            <h6 className="text-sm md:text-lg text-[#213C58]">
                                Active
                ...
                <div className="hidden md:grid grid-cols-4 gap-6 px-12" data-aos="fade-up">
                    {[
                ...
                <section className="relative w-screen left-1/2 right-1/2 -mx-[50vw] md:hidden overflow-hidden" data-aos="fade-up">
                    <div className="grid grid-cols-2 gap-0 w-screen">
                        {[
                            { title: "RELIABILITY", icon: "/assets/bg1.png" },
                            { title: "QUALITY ASSURANCE", icon: "/assets/bg2.png" },
                            { title: "PARTNERSHIP", icon: "/assets/bg3.png" },
                            ...
                            <div
                                key={index}
                                className="relative flex items-center justify-center overflow-hidden transition-transform duration-500 hover:scale-105 w-full"
                                style={{
                                    backgroundImage: "url('/assets/Concrete Texture 8.png')",
                                    backgroundSize: "cover",
                                    backgroundPosition: "center",
